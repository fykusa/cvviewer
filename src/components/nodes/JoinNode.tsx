        ...
        <div
          ...
          onClick={(e) => {
            ...
            window.dispatchEvent(
              new CustomEvent('open-node-join', { detail: { nodeId: data.id } })
            );
          }}
        >
          <VennIcon
            vennType={data.joinType === 'leftOuter' ? 'left' : data.joinType === 'rightOuter' ? 'right' : data.joinType === 'fullOuter' ? 'full' : 'inner'}
