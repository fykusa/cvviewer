...
1. Přečti soubor `doc/implementation_plan.md` pro zjištění aktuálního plánu a zařazení nové funkcionality do kontextu celého projektu.
2. Přečti soubor `doc/development.md` pro pochopení technického stavu, zvyklostí a důležitých poznámek z předchozího vývoje.
